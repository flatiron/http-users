...
module.exports = function (app) {
  ...
  //
  app.router.before(/\/permissions/, app.requireAuth);
  app.router.before(/\/permissions/, app.needPermission('modify permissions'));
  app.router.param(':perm', /([\w\s\-]+)/);

  //
  // Define the `Permission` resource
  //
  var Permission = app.resources.Permission = app.define('Permission', function () {
    var self = this;
