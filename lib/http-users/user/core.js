...
exports.resource = function (app) {
  ...
  var User = app.resources.User = app.define('User', function () {
    ...
    this.string('username').sanitize('lower').pattern(
      disallowed.username instanceof RegExp
        ? disallowed.username
...
exports.routes = function (app) {
  ...
  if (app.unauthorized) app.unauthorized.path('/users', function () {
    ...
    this.get('/:username/available', function (username) {
      ...
      app.resources.User.available(decodeURIComponent(username), function (err, available) {
        return err
