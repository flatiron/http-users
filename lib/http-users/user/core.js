...
exports.routes = function (app) {
  ...
  app.router.before('/users/:username', function (username) {
    ...
    if (self.req.method === 'PUT' && self.req.body) {
      ...
      //
      // User has flag that their e-mail was changed, reset the inviteCode
      // and force the status to pending.
      //
      if (self.req.body.emailChanged === true) {
        self.req.body.status = 'pending';
        self.req.body.inviteCode = uuid.v4();
      }
    }
